...
function Info() {
    return (
        ...
        <div className="container">
            ...
            <ul>
                <a className="info" href='https://courses.edx.org/certificates/104c73449a9340108ea665d055cd8150' target="_blank">
                ...
                <a className="info" href="https://play.google.com/store/apps/developer?id=Don%C8%9Bu+Daniel+Nicolae" target="_blank">
